...
function App() {      //Need curly brackets if you export up here. Does it have anything to do with default
...
export default App; //Don't need curly brackets if export down here
